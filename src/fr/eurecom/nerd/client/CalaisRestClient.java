...
import fr.eurecom.nerd.client.CalaisConfig.ConnParam;
import fr.eurecom.nerd.client.CalaisConfig.ProcessingParam;
import fr.eurecom.nerd.client.CalaisConfig.UserParam;
...
public  class CalaisRestClient implements CalaisClient {
  ...
  private static  int MAX_CONTENT_SIZE = 100000;
