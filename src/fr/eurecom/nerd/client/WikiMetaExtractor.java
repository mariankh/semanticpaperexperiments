...
public class WikiMetaExtractor {
     ...
     * 
     */
	public String getResult1(String apiKey, Format format, String content, String lng, int threshold) {
		return WikiMetaExtractor.getResult(apiKey, format, content, threshold, 100, lng ,true, 0);
	}
     ...
     * 
     */
	public String getResult(String apiKey, Format format, String content, String lng, int stats) {
    ...
    public static String getResult(String apiKey, Format format, String content, int treshold, int span, String lng, boolean semtag, int stats) {    
        ...
        catch (Exception e)
        {
           ...
           System.out.println(""+ (WikiMetaExtractor.class.getName()));
